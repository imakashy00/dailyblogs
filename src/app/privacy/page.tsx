...
const page = () => {
  return (
    <div className="w-1/2 m-auto space-y-5 my-10 py-10">
      <h1 className="flex justify-center text-4xl underline">Privacy Policy</h1>
      <p className="underline">Last updated: September 07, 2024</p>
      <p>
      ...
      <h2 className="text-2xl underline">Interpretation and Definitions</h2>
      <h3 className="`text-xl underline">Interpretation</h3>
      <p>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to dailyblogs.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to dailyblogs, accessible from{" "}
            <a
              href="https://www.dailyblogs.co/"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://www.dailyblogs.co/
            </a>
          </p>
        </li>
        <li>
      ...
      <h3 className="text-2xl underline">Types of Data Collected</h3>
      <h4 className="text-xl underline">Personal Data</h4>
      <p>
      ...
      <h4 className="text-xl underline">Usage Data</h4>
      ...
      <h4 className="text-xl underline">Tracking Technologies and Cookies</h4>
      <p>
      ...
      <h3 className="text-2xl underline">Use of Your Personal Data</h3>
      ...
      <h3 className="text-2xl underline">Retention of Your Personal Data</h3>
      <p>
      ...
      <h3 className="text-2xl underline">Transfer of Your Personal Data</h3>
      <p>
      ...
      <h4 className="text-xl underline">Law enforcement</h4>
      <p>
        Under certain circumstances, the Company may be required to disclose
        Your Personal Data if required to do so by law or in response to valid
        requests by public authorities (e.g. a court or a government agency).
      </p>
      <h4 className="text-xl underline">Other legal requirements</h4>
      <p>
      ...
      <h3 className="text-2xl underline">Security of Your Personal Data</h3>
      <p>
      ...
      <h2 className="text-2xl underline">Children&rsquo;s Privacy</h2>
      <p>
      ...
      <h2 className="text-xl underline">Links to Other Websites</h2>
      <p>
      ...
      <h2 className="text-xl underline">Changes to this Privacy Policy</h2>
      <p>
      ...
      <h2 className="text-2xl underline">Contact Us</h2>
      <p>
        If you have any questions about this Privacy Policy, You can contact us:
      </p>
      <ul>
        <li className="font-bold bg-yellow-300 p-5 rounded-lg text-3xl">
          📧 email:{" "}
          <Link href="mailto:imakashy00@gmail.com">imakashy00@gmail.com</Link>
        </li>
      </ul>
    </div>
  );
