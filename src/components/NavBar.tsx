...
const NavBar: React.FC = () => {
  ...
  return (
    <>
      <nav className="w-1/5 p-10 mr-5 bg-white shadow-lg flex flex-col justify-between  rounded-xl fixed left-0 top-0 h-full">
        ...
        <Button className="w-1/2 ml-2 bg-white hover:bg-red-200 text-red-600 flex "
        onClick={() => signOut()}>
